...
public class GenerateSAMLToken {
    ...
    protected String getSAMLAssertionFromOAuth(String token, String issuer)
            throws AuthenticationFailedException, IdentityException, CarbonException, UserStoreException, IdentityApplicationManagementException {
    ...
    private Response buildSAMLResponse(String issuer, String userName) throws IdentityException, CarbonException, UserStoreException, IdentityApplicationManagementException {
    ...
    private Assertion buildSAMLAssertion(SAMLSSOServiceProviderDO ssoIdPConfigs,
            ...
            throws IdentityException, UserStoreException, CarbonException, IdentityApplicationManagementException {
     ...
     */
    private Map<String, String> getSPClaims(String username, String issuer) throws IdentityException, CarbonException, UserStoreException, IdentityApplicationManagementException {//exceptions are thrown in this currently
        Map<String, String> spClaimMap = null;
        int index = 0;

        ApplicationInfoProvider appInfo = ApplicationInfoProvider.getInstance();
        try {
            ServiceProvider serviceProvider = appInfo.getServiceProviderByClienId(issuer, SAMLSSO, CARBON_SUPER);
            org.wso2.carbon.identity.application.common.model.ClaimMapping[] claimMappings = new org.wso2.carbon.identity.application.common.model.ClaimMapping[serviceProvider.getClaimConfig().getClaimMappings().length];
            String[] claims = new String[serviceProvider.getClaimConfig().getClaimMappings().length];
